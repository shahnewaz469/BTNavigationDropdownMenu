...
class BTMenuCell: UITableViewCell {
    ...
    init(style: UITableViewCellStyle, reuseIdentifier: String?, configuration: BTConfiguration) {
        ...
        let widthConstraint2 = NSLayoutConstraint(item: self.countLabel, attribute: .width, relatedBy: NSLayoutRelation.greaterThanOrEqual, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 42)
