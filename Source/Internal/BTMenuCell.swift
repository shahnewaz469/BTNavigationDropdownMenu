...
class BTMenuCell: UITableViewCell {
    ...
    init(style: UITableViewCellStyle, reuseIdentifier: String?, configuration: BTConfiguration) {
        ...
        let heightConstraint2 = NSLayoutConstraint(item: self.countLabel, attribute: .height, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 30)
